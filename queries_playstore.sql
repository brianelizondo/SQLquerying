...
SELECT category, count(*) FROM analytics GROUP BY category ORDER BY category ASC;
...
SELECT category, AVG(rating) AS average_rating FROM analytics GROUP BY category ORDER BY AVG(rating) DESC;
